...
document.writeln("	background: url(\'https://cdn.wlsonsult.com/img/main6_bg.jpg\')  no-repeat scroll center;");
document.writeln("	z-index: 1001;");
document.writeln("}");
document.writeln(".closeee{");
document.writeln("	background: url(\'https://cdn.wlsonsult.com/img/closesanjiao.png\')  no-repeat center center;");
document.writeln("}");
...
document.writeln("			<img src=\'https://cdn.wlsonsult.com/img/51.gif\'>");
