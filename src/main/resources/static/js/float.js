...
document.writeln("	background: url(\'https://style4.jjcsweb.com/img/main6_bg.jpg\')  no-repeat scroll center;");
document.writeln("	z-index: 1001;");
document.writeln("}");
document.writeln(".closeee{");
document.writeln("	background: url(\'https://style4.jjcsweb.com/img/closesanjiao.png\')  no-repeat center center;");
document.writeln("}");
...
document.writeln("			<img src=\'https://style4.jjcsweb.com/img/51.gif\'>");
